...
```
git clone https://github.com/Brownlow/bamazon
```
...
![Bamazon Customer](gifs/bamazonCustomer.gif)
...
![Bamazon Manager](gifs/bamazonManager.gif)
...
3. Selecting `Create New Department` will prompt the supervisor with two messages. Supervisor should:
...
![Bamazon Supervisor](gifs/bamazonSupervisor.gif)
